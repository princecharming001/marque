...
- First person is FINE for opinions, habits and methods ("here's what I do", "I'd never", "what actually works is"). What's banned is first-person EVENTS and RESULTS no source gives you: "last week I...", "I tried this for 30 days", "my revenue doubled". Stories default to "you" (POV) or "most people" framing.

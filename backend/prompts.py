...
def edit_plan_prompt(style: str, transcript_words: list[dict], script: dict, brand: dict,
    ...
    system = (
        ...
        "word, never a wind-down. A REAL CTA (follow/link-in-bio) may survive but only TIGHT — the final "
        "~2–3s max: cut any CTA preamble/wind-up so the ask lands and the video stops.\n"
